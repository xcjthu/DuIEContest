...
all_data = [json.loads(line) for line in open("/data/disk1/private/xcj/DuIE/data/Sent-EE/duee_test1.json/duee_test1.json", "r")]
id2index = {doc["id"]: idx for idx, doc in enumerate(all_data)}
data = []
for f in ["ArgExt-sent.json"]:
...
schema = [json.loads(line) for line in open("/data/disk1/private/xcj/DuIE/data/Sent-EE/duee_schema/duee_event_schema.json", "r")]
